$(function(){        
    ...
    var rdc = new Rickshaw.Graph( {
            ...
            height: 250,
            series: [{color: "#33414E",data: seriesData[0],name: 'Logged in Time'}, 
                     {color: "#3FBAE4",data: seriesData[1],name: 'Logged out Time'}]
    } );
    ...
    Morris.Donut({
        ...
        data: [
            {label: "Quran", value: 2513},
            {label: "Arabic", value: 764},
            {label: "Others", value: 311}
        ],
    ...
    Morris.Line({
      ...
      data: [
        ...
        { y: '2014-10-11', a: 5,b: 6},
        { y: '2014-10-12', a: 5,b: 10},
        { y: '2014-10-13', a: 5,b: 7},
        { y: '2014-10-14', a: 5,b: 9},
        { y: '2014-10-15', a: 5,b: 12},
        { y: '2014-10-16', a: 5,b: 20}
      ],
      xkey: 'y',
      ykeys: ['a','b'],
