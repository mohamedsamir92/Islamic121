...
<option value="<?php echo $currency->id ?>"><?php echo $currency -> sign; ?></option>
<?php } ?>
</select></td>

<td>
<input type="number" step="any" class="form-control" name="LessonRequest[cost]" form="myform<?php echo $j; ?>">
</td>
...
<td>
<div class="btn-group">
<button href="#myModal<?php echo $j; ?>" id="openBtn" data-toggle="modal" class="btn btn-default btn-condensed"><i class="fa fa-calendar"></i></button>
                                             
<button class="btn btn-default btn-condensed"><i class="fa fa-pencil"></i></button>
<button class="btn btn-danger btn-condensed"><i class="fa fa-times"></i></button>                                                
<button type="submit" form="myform<?php echo $j; ?>" class="btn btn-success btn-condensed"><i class="fa fa-check"></i></button>      </div>
