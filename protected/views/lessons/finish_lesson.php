			...
			<form class="form-horizontal" action="index.php?r=Lessons/changeLessonState" method="post">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-md-3 col-xs-12 control-label">Actual Start Time</label>
							<div class="col-md-6 col-xs-12">
								<div class="input-group">
									<span class="input-group-addon"><span class="fa fa-calendar"></span></span>
									<input type="text" class="form-control" disabled="" value="<?php echo $lesson->actual_start_time; ?>">
								</div>
							</div>
						</div>
					...
					<div class="panel-footer">
						<button type="submit" class="btn btn-danger pull-right">End Lesson Now</button>
					</div>
				</div>
			</form>
