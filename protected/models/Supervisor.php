 ...
 * @property SupervisorTimeSlot[] $supervisorTimeSlots
 */
class Supervisor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('first_name, last_name, phone_no, email, skype_id, username, password, age, country, city, gender, image, quran_course, arabic_course, spoken_languages, experience, notes', 'required'),
			...
			array('spoken_languages', 'length', 'max'=>200),
			array('experience', 'length', 'max'=>300),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, first_name, last_name, phone_no, email, skype_id, username, password, age, country, city, gender, image, quran_course, arabic_course, spoken_languages, experience, notes', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'supervisorTimeSlots' => array(self::HAS_MANY, 'SupervisorTimeSlot', 'supervisor_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('spoken_languages',$this->spoken_languages,true);
