 ...
 *
 * The followings are the available columns in table 'validation_rules':
 * @property integer $id
 ...
 */
class ValidationRules extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'lessonType' => array(self::BELONGS_TO, 'LessonType', 'lesson_type'),
		);
	}
	 ...
	 * @return ValidationRules the static model class
	 */
