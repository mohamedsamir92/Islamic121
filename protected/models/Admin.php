 ...
 * @property AdminTimeSlot[] $adminTimeSlots
 */
class Admin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('age, gender', 'numerical', 'integerOnly'=>true),
			...
			array('id, first_name, last_name, phone_no, email, skype_id, username, password, age, country, city, gender, image, notes', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'adminTimeSlots' => array(self::HAS_MANY, 'AdminTimeSlot', 'admin_id'),
		);
	}
